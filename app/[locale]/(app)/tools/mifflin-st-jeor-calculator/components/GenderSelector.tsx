      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          <div className={`p-2 rounded-lg transition-all duration-300 ${
            value === "male" 
              ? "bg-[#4F8EF7]/20 dark:bg-[#4F8EF7]/15" 
              : "bg-base-200 dark:bg-base-300/20 group-hover:bg-[#4F8EF7]/10"
          }`}>
            <UserIcon className={`w-5 h-5 transition-colors duration-300 ${
        ...
        >
          <div className={`p-2 rounded-lg transition-all duration-300 ${
            value === "female" 
              ? "bg-[#FF5722]/20 dark:bg-[#FF5722]/15" 
              : "bg-base-200 dark:bg-base-300/20 group-hover:bg-[#FF5722]/10"
          }`}>
