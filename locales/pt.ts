...
export default {
  ...
  tools: {
    ...
    "peptide-calculator": {
      ...
      presets_legend: "Tamanhos rápidos de frasco",
      step_1_eyebrow: "Equipamento",
      step_1_title: "Qual seringa você está usando?",
      step_2_eyebrow: "Reconstituição",
      step_2_title: "Quantidade no frasco",
      step_3_eyebrow: "Diluição",
      step_3_title: "Água bacteriostática adicionada",
      step_4_eyebrow: "Injeção",
      step_4_title: "Dose alvo",
      other: "Outro",
      units: "unidades",
      mode_legend: "Direção do cálculo",
      mode_forward: "Dose → unidades",
      mode_reverse: "Unidades → dose",
      step_4_reverse_eyebrow: "Injeção",
      step_4_reverse_title: "Unidades puxadas",
      result: {
        eyebrow: "Seu resultado",
        draw_to: "Puxe até",
        dose_is: "Isso equivale a",
        concentration: "Concentração",
        doses_per_vial: "Doses por frasco",
