    ...
    <div className="mt-12 bg-base-200/30 dark:bg-base-200/20 rounded-2xl border border-base-content/10 dark:border-base-content/5 p-6 sm:p-8">
      ...
      <div className="space-y-4">
        {faqs.map((faq, index) => (
          <div
            key={index}
            className="border border-base-content/10 dark:border-base-content/5 rounded-xl overflow-hidden transition-all duration-300 hover:border-primary/30"
          >
            <button
            ...
            >
              <h3 className="font-semibold text-base-content dark:text-base-content/90">
                {faq.question}
              </h3>
              <ChevronDownIcon
            ...
            >
              <p className="text-sm text-base-content/70 dark:text-base-content/60 leading-relaxed">
                {faq.answer}
              </p>
            </div>
          </div>
