export default {
  ...
  tools: {
    ...
    "rest-timer": {
      title: "Таймер отдыха",
      description: "Умный таймер для оптимизации периодов отдыха между подходами",
    },
    ...
    body_fat_info_content: "Процент жира в теле важен для формул Катча-МакАрдла и Каннингема, поскольку они рассчитывают на основе тощей массы тела. Если вы не знаете точный процент жира в теле, используйте онлайн визуальные руководства или DEXA-сканирование для точности.",
    "calorie-calculator-hub": {
      ...
      meta: {
        ...
        description: "Сравните различные формулы BMR: Миффлина-Сан Жеора, Харриса-Бенедикта, Катча-МакАрдла, Каннингема и Оксфорда. Выберите лучший калькулятор калорий для ваших потребностей.",
        keywords: "формулы BMR, сравнение калькуляторов калорий, Миффлин-Сан Жеор, Харрис-Бенедикт, Катч-МакАрдл, Каннингем, Оксфорд, калькулятор TDEE",
      },
      ...
      "mifflin-st-jeor": {
        ...
        description: "Наиболее точная формула для общей популяции, разработанная в 1990 году. В настоящее время золотой стандарт для расчетов BMR.",
      },
      "harris-benedict": {
        title: "Харрис-Бенедикт (Классическая)",
        description: "Пересмотренная версия 1984 года классической формулы. Широко используется, но имеет тенденцию переоценивать калории для некоторых людей.",
      },
      "katch-mcardle": {
    ...
    "mifflin-st-jeor": {
      ...
      meta: {
        ...
        description: "Рассчитайте BMR и TDEE, используя уравнение Миффлина-Сан Жеора - наиболее точную формулу для общей популяции. Получите персонализированные рекомендации по калориям.",
        keywords: "калькулятор Миффлина-Сан Жеора, калькулятор BMR, калькулятор TDEE, наиболее точный калькулятор калорий, калькулятор метаболизма",
      },
      how_it_works: "Как работает формула Миффлина-Сан Жеора",
      how_it_works_description: "Разработанная в 1990 году, эта формула считается наиболее точной для расчета базальной скорости метаболизма (BMR) у здоровых взрослых. Она более точная, чем уравнение Харриса-Бенедикта, и широко рекомендуется диетологами и фитнес-профессионалами.",
    },
    "harris-benedict": {
      ...
      meta: {
        ...
        description: "Рассчитайте BMR и TDEE, используя пересмотренное уравнение Харриса-Бенедикта (1984). Классическая формула, которая начала современные расчеты калорий.",
        keywords: "калькулятор Харриса-Бенедикта, классический калькулятор BMR, традиционный калькулятор TDEE, пересмотренная формула Харриса-Бенедикта",
      },
      how_it_works: "Как работает формула Харриса-Бенедикта",
      how_it_works_description: "Первоначально разработанная в 1919 году и пересмотренная в 1984 году, уравнение Харриса-Бенедикта было одной из первых формул для расчета BMR. Хотя она немного менее точная, чем новые формулы, она остается широко используемой и дает хорошие оценки для большинства людей.",
    },
    "katch-mcardle": {
      ...
      meta: {
        ...
        description: "Рассчитайте BMR и TDEE, используя формулу Катча-МакАрдла на основе тощей массы тела. Наиболее точная для людей, которые знают процент жира в теле.",
        keywords: "калькулятор Катча-МакАрдла, BMR тощей массы тела, калькулятор процента жира в теле, калькулятор BMR спортсмена, точный TDEE",
      },
      how_it_works: "Как работает формула Катча-МакАрдла",
      how_it_works_description: "Эта формула рассчитывает BMR на основе тощей массы тела, а не общего веса тела, что делает ее более точной для людей, которые знают процент жира в теле. Она особенно полезна для спортсменов и физически активных людей.",
    },
    "cunningham": {
      ...
      meta: {
        ...
        description: "Рассчитайте BMR и TDEE, используя формулу Каннингема, специально разработанную для очень худых спортсменов и бодибилдеров с низким процентом жира.",
        keywords: "калькулятор Каннингема, калькулятор BMR бодибилдера, BMR худого спортсмена, калькулятор BMR низкого жира, калькулятор подготовки к соревнованиям",
      },
      how_it_works: "Как работает формула Каннингема",
      how_it_works_description: "Разработанная специально для очень худых людей с низким процентом жира в теле, эта формула дает более высокие оценки BMR, чем другие уравнения. Она наиболее точна для соревнующихся спортсменов и бодибилдеров в подготовке к соревнованиям.",
    },
    "oxford": {
      ...
      meta: {
        ...
        description: "Рассчитайте BMR и TDEE, используя уравнение Оксфорда (2005), современную формулу на основе европейских популяций с возрастными расчетами.",
        keywords: "калькулятор Оксфорда, современный калькулятор BMR, европейская формула BMR, возрастной калькулятор BMR, уравнение BMR 2005",
      },
      how_it_works: "Как работает формула Оксфорда",
      how_it_works_description: "Опубликованная в 2005 году, это одна из более современных формул BMR. Она была разработана с использованием данных европейских популяций и учитывает возрастные группы, предоставляя разные уравнения для людей младше и старше 30 лет.",
    },
  },
  levels: {
    BEGINNER: "Начальный",
