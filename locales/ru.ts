export default {
  ...
  ads: {
    advertise: "Реклама",
    click_to_advertise: "Нажмите, чтобы разместить рекламу →",
    dialog_title: "Реклама на Workout.cool",
    dialog_description: "Охватите тысячи любителей фитнеса каждый месяц",
    monthly_visitors: "Посетители / мес",
    monthly_page_views: "Просмотры",
    avg_session_duration: "Сред. сессия",
    demographics: "Демография",
    top_countries: "Топ стран",
    similarweb_placeholder: "Скриншот аналитики SimilarWeb скоро",
    pricing_starting_at: "От",
    month: "мес",
    feature_logo_link: "Ваш логотип и ссылка на каждой странице",
    feature_visitors: "50K+ посетителей в месяц",
