export default {
  ...
  ads: {
    ...
    click_to_advertise: "Clique para colocar seu anúncio aqui →",
    dialog_title: "Anuncie no Workout.cool",
    dialog_description: "Alcance milhares de entusiastas de fitness todos os meses",
    monthly_visitors: "Visitantes / mês",
    monthly_page_views: "Visualizações",
    avg_session_duration: "Sessão méd.",
    demographics: "Demografia",
    top_countries: "Principais países",
    similarweb_placeholder: "Captura de análise SimilarWeb em breve",
    pricing_starting_at: "A partir de",
    month: "mês",
    feature_logo_link: "Seu logo e link exibidos em cada página",
    feature_visitors: "Visível para 50K+ visitantes mensais",
