export default {
  ...
  tools: {
    ...
    "heart-rate-zones": {
      ...
      description: "Рассчитайте оптимальные зоны тренировочного пульса для максимальной производительности и сжигания жира",
      page_title: "Калькулятор зон пульса",
      page_description: "Рассчитайте персонализированные зоны тренировочного пульса, используя научно обоснованные формулы. Оптимизируйте кардиотренировки для сжигания жира, выносливости и производительности.",
      meta: {
        title: "Калькулятор зон пульса - Целевой пульс и тренировочные зоны",
        description: "Рассчитайте максимальный пульс и персонализированные тренировочные зоны. Используйте базовые формулы или Карвонена для определения зон VO2 Max, анаэробной, аэробной, жиросжигания и разминки.",
        keywords: "калькулятор зон пульса, целевой пульс, максимальный пульс, тренировочные зоны, зона VO2 max, анаэробная зона, аэробная зона, зона жиросжигания, формула Карвонена, тренировка по пульсу",
      },
      calculate: "Рассчитать зоны",
      calculating: "Расчет...",
      method: "Метод расчета",
      method_info: "Выберите формулу, которая лучше всего подходит для вашего уровня физической подготовки и доступных данных",
      methods: {
        basic: "Базовый по возрасту",
        basic_desc: "Простая формула, использующая только возраст - хорошо для начинающих",
        karvonen_age: "Карвонен по возрасту и ЧСС покоя",
        karvonen_age_desc: "Более точный с использованием возраста и пульса в покое",
        karvonen_custom: "Карвонен по макс. ЧСС и ЧСС покоя",
        karvonen_custom_desc: "Наиболее точный с использованием измеренных максимального пульса и пульса в покое",
      },
      age: "Возраст",
      age_placeholder: "Введите ваш возраст",
      resting_heart_rate: "Пульс в покое (ЧСС покоя)",
      resting_heart_rate_placeholder: "Введите ваш пульс в покое",
      resting_heart_rate_info: "Измерьте пульс при пробуждении, до того как встать с кровати. Нормальный диапазон 60-100 уд/мин.",
      max_heart_rate: "Максимальный пульс (макс. ЧСС)",
      max_heart_rate_placeholder: "Введите ваш макс. пульс",
      max_heart_rate_info: "Ваш фактический максимальный пульс из стресс-теста или тренировки с максимальным усилием. Точнее, чем оценки на основе возраста.",
      results: {
        title: "Ваши зоны пульса",
        max_heart_rate: "Максимальный пульс",
        heart_rate_reserve: "Резерв пульса",
        target_zones: "Целевые тренировочные зоны",
        zone: "Зона",
        intensity: "Интенсивность",
        heart_rate_range: "Пульс (уд/мин)",
        benefits: "Преимущества",
        duration: "Типичная продолжительность",
      },
      zones: {
        warm_up: {
          name: "Зона разминки",
          intensity: "50-60%",
          benefits: "Подготавливает тело к упражнениям, улучшает гибкость",
          duration: "5-10 минут",
          description: "Очень легкая интенсивность для разминки и заминки",
        },
        fat_burn: {
          name: "Зона жиросжигания",
          intensity: "60-70%",
          benefits: "Максимальное сжигание жира, строит базу выносливости",
          duration: "20-40 минут",
          description: "Легкая интенсивность, комфортный темп для длительных тренировок",
        },
        aerobic: {
          name: "Аэробная зона",
          intensity: "70-80%",
          benefits: "Улучшает сердечно-сосудистую систему и выносливость",
          duration: "10-40 минут",
          description: "Умеренная интенсивность, устойчивая в течение длительных периодов",
        },
        anaerobic: {
          name: "Анаэробная зона",
          intensity: "80-90%",
          benefits: "Увеличивает скорость и мощность, наращивает мышцы",
          duration: "2-10 минут",
          description: "Тяжелая интенсивность, сложная, но устойчивая для коротких периодов",
        },
        vo2_max: {
          name: "Зона VO2 Max",
          intensity: "90-100%",
          benefits: "Максимальная производительность, увеличивает VO2 max",
          duration: "30 секунд - 2 минуты",
          description: "Максимальная интенсивность, устойчивая только для очень коротких рывков",
        },
      },
      formulas: {
        basic_formula: "Базовая формула",
        basic_explanation: "ЦП = Макс. ЧСС × %Интенсивности",
        karvonen_formula: "Формула Карвонена",
        karvonen_explanation: "ЦП = [(Макс. ЧСС - ЧСС покоя) × %Интенсивности] + ЧСС покоя",
        mhr_calculation: "Макс. ЧСС = 220 - Возраст",
      },
      abbreviations: {
        thr: "ЦП = Целевой пульс",
        mhr: "Макс. ЧСС = Максимальная частота сердечных сокращений",
        rhr: "ЧСС покоя = Частота сердечных сокращений в покое",
        hrr: "РП = Резерв пульса",
        bpm: "уд/мин = Ударов в минуту",
      },
      tips: {
        title: "Советы по тренировкам",
        tip1: "Начните с зон низкой интенсивности, если вы новичок в упражнениях",
        tip2: "Смешивайте разные зоны в вашей недельной тренировке для лучших результатов",
        tip3: "Используйте пульсометр для точного отслеживания во время тренировок",
        tip4: "Ваши зоны могут меняться по мере улучшения физической формы - пересчитывайте периодически",
      },
      faq: {
        title: "Часто задаваемые вопросы",
        q1: "Какой метод расчета мне использовать?",
        a1: "Если вы только начинаете, используйте базовый метод. Если знаете свой пульс в покое, используйте Карвонен по возрасту для большей точности. Для наиболее точных зон используйте Карвонен с измеренными макс. ЧСС и ЧСС покоя.",
        q2: "Как измерить пульс в покое?",
        a2: "Измерьте пульс в течение 60 секунд сразу после пробуждения, до того как встать с кровати. Делайте это 3-5 дней и используйте среднее значение. Нормальный пульс покоя 60-100 уд/мин, более низкие значения указывают на лучшую физическую форму.",
        q3: "В какой зоне тренироваться для похудения?",
        a3: "Зона жиросжигания (60-70%) оптимальна для сжигания жира в качестве топлива. Однако зоны более высокой интенсивности сжигают больше общих калорий. Смешивайте зоны для лучших результатов - включайте как тренировки жиросжигания, так и высокой интенсивности.",
        q4: "Насколько точна формула 220-возраст?",
        a4: "Это общая оценка, которая работает для большинства людей, но может варьироваться на ±10-15 уд/мин. Для большей точности рассмотрите контролируемый тест максимального пульса или используйте формулу Карвонена с вашими фактическими измерениями.",
        q5: "Могу ли я тренироваться в зоне VO2 Max каждый день?",
        a5: "Нет, зона VO2 Max чрезвычайно интенсивна и должна использоваться только 1-2 раза в неделю для коротких интервалов. Большая часть тренировок должна быть в аэробной зоне и зоне жиросжигания для развития выносливости и восстановления.",
      },
      educational: {
        title: "Понимание тренировок по пульсу",
        what_are_zones: {
          title: "Что такое зоны пульса?",
          content: "Зоны пульса - это диапазоны ударов в минуту, которые соответствуют различным интенсивностям упражнений. Тренировки в определенных зонах помогают более эффективно достигать различных фитнес-целей.",
        },
        why_use_zones: {
          title: "Зачем использовать зоны пульса?",
          content: "Тренировки с зонами пульса гарантируют, что вы тренируетесь с правильной интенсивностью для ваших целей. Это предотвращает перетренированность, максимизирует результаты и помогает тренироваться более эффективно.",
        },
        zone_distribution: {
          title: "Рекомендуемое недельное распределение зон",
          content: "Для сбалансированной физической формы: 80% в зонах 1-3 (аэробная база), 15% в зоне 4 (порог), 5% в зоне 5 (VO2 max). Корректируйте в зависимости от ваших конкретных целей и уровня физической подготовки.",
        },
        monitoring: {
          title: "Как контролировать пульс",
          content: "Используйте нагрудный ремень для большей точности или наручный монитор для удобства. Регулярно проверяйте пульс во время упражнений и корректируйте интенсивность, чтобы оставаться в целевой зоне.",
        },
      },
    },
    "one-rep-max": {
