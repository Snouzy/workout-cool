  ...
  tools: {
    ...
    "calorie-calculator": {
      ...
      meta: {
        ...
        description: "Calculez votre Dépense Énergétique Journalière Totale (TDEE) et vos besoins caloriques. Obtenez des recommandations personnalisées pour la perte de poids, le maintien ou la prise de muscle.",
        keywords: "calculateur calories, calculateur TDEE, calories quotidiennes, calculateur perte de poids, besoins caloriques, calculateur métabolisme de base",
      },
      ...
      activity: {
        ...
        sedentary_desc: "Peu ou pas d'exercice",
        light: "Légèrement Actif",
        light_desc: "Exercice léger 1-3 jours/semaine",
        moderate: "Modérément Actif",
        moderate_desc: "Exercice modéré 3-5 jours/semaine",
        active: "Très Actif",
        active_desc: "Exercice intense 6-7 jours/semaine",
        very_active: "Extrêmement Actif",
        very_active_desc: "Travail physique très intense ou entraînement",
      },
      goal: "Objectif",
      goals: {
        lose_fast: "Perdre du Poids Rapidement",
        lose_fast_desc: "Perdre 1 kg par semaine",
        lose_slow: "Perdre du Poids",
        lose_slow_desc: "Perdre 0,5 kg par semaine",
        maintain: "Maintenir le Poids",
        maintain_desc: "Rester au poids actuel",
        gain_slow: "Prendre du Poids",
        gain_slow_desc: "Prendre 0,5 kg par semaine",
        gain_fast: "Prendre du Poids Rapidement",
        gain_fast_desc: "Prendre 1 kg par semaine",
      },
      results: {
        title: "Vos Résultats",
        bmr: "MB",
        ...
        carbs: "Glucides",
        fat: "Lipides",
        disclaimer: "Ces calculs sont des estimations basées sur des formules moyennes. Les besoins caloriques réels peuvent varier selon les facteurs individuels. Consultez un professionnel de santé ou un diététicien pour des conseils personnalisés.",
      },
    },
    "macro-calculator": {
