...
> = {
  ...
  ua: {
    title: "Визначте свої ідеальні зони пульсу для оптимальних тренувань",
    description:
      "Розрахуйте свої персональні зони пульсу за допомогою нашого безкоштовного калькулятора. Базові та формули Карвонена, таблиця за віком, повний посібник для оптимізації кардіо тренувань.",
    keywords: [
