          ...
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                ...
                {isActive && (
                  <div
                    className="absolute -top-0.5 left-1/2 transform -translate-x-1/2 w-4 sm:w-6 h-0.5 rounded-full bg-gradient-to-r from-[#4F8EF7] to-[#25CB78]"
                  />
                )}
                ...
                <div className="relative flex items-center justify-center">
                  ...
                  {isActive && (
                    <div
                      className="absolute inset-0 rounded-full blur-sm scale-150 bg-gradient-to-br from-[#4F8EF7]/15 to-[#25CB78]/15"
                    />
                  )}
