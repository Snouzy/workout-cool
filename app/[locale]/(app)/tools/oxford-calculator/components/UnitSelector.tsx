      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          <div className={`p-2 rounded-lg transition-all duration-300 ${
            value === "metric" 
              ? "bg-[#25CB78]/20 dark:bg-[#25CB78]/15" 
              : "bg-base-200 dark:bg-base-300/20 group-hover:bg-[#25CB78]/10"
          }`}>
            <GlobeIcon className={`w-5 h-5 transition-colors duration-300 ${
        ...
        >
          <div className={`p-2 rounded-lg transition-all duration-300 ${
            value === "imperial" 
              ? "bg-[#F59E0B]/20 dark:bg-[#F59E0B]/15" 
              : "bg-base-200 dark:bg-base-300/20 group-hover:bg-[#F59E0B]/10"
          }`}>
            <RulerIcon className={`w-5 h-5 transition-colors duration-300 ${
