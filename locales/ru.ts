export default {
  ...
  tools: {
    ...
    "heart-rate-zones": {
      ...
      page_description:
        "Рассчитайте персонализированные зоны тренировочного пульса, используя научно обоснованные формулы. Оптимизируйте кардиотренировки для сжигания жира, выносливости и производительности.",
      meta: {
        title: "Калькулятор зон пульса - Целевой пульс и тренировочные зоны",
        description:
          "Рассчитайте максимальный пульс и персонализированные тренировочные зоны. Используйте базовые формулы или Карвонена для определения зон VO2 Max, анаэробной, аэробной, жиросжигания и разминки.",
        keywords:
          "калькулятор зон пульса, целевой пульс, максимальный пульс, тренировочные зоны, зона VO2 max, анаэробная зона, аэробная зона, зона жиросжигания, формула Карвонена, тренировка по пульсу",
      },
      ...
      max_heart_rate_info:
        "Ваш фактический максимальный пульс из стресс-теста или тренировки с максимальным усилием. Точнее, чем оценки на основе возраста.",
      results: {
      ...
      zones: {
        ...
        fat_burn: {
          ...
          intensity: "60-70%",
          benefits: "🔥 Максимальное сжигание жира",
          example: "Легкий бег",
        ...
        vo2_max: {
          name: "Зона VO2 Max",
          intensity: "90-100%",
          benefits: "🏆 Максимальная производительность",
          example: "Спринт интенсивный",
      ...
      educational: {
        ...
        what_are_zones: {
          ...
          content:
            "Зоны пульса - это диапазоны ударов в минуту, которые соответствуют различным интенсивностям упражнений. Тренировки в определенных зонах помогают более эффективно достигать различных фитнес-целей.",
        },
        why_use_zones: {
          title: "Зачем использовать зоны пульса?",
          content:
            "Тренировки с зонами пульса гарантируют, что вы тренируетесь с правильной интенсивностью для ваших целей. Это предотвращает перетренированность, максимизирует результаты и помогает тренироваться более эффективно.",
        },
        zone_distribution: {
          title: "Рекомендуемое недельное распределение зон",
          content:
            "Для сбалансированной физической формы: 80% в зонах 1-3 (аэробная база), 15% в зоне 4 (порог), 5% в зоне 5 (VO2 max). Корректируйте в зависимости от ваших конкретных целей и уровня физической подготовки.",
        },
        monitoring: {
          title: "Как контролировать пульс",
          content:
            "Используйте нагрудный ремень для большей точности или наручный монитор для удобства. Регулярно проверяйте пульс во время упражнений и корректируйте интенсивность, чтобы оставаться в целевой зоне.",
        },
      },
    },
    "one-rep-max": {
