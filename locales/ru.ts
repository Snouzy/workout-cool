export default {
  ...
  tools: {
    ...
    "peptide-calculator": {
      ...
      description: "Переведите дозу пептида в миллилитры и единицы инсулинового шприца U-100",
      presets_legend: "Быстрый выбор объёма флакона",
      step_1_eyebrow: "Оборудование",
      step_1_title: "Каким шприцем вы пользуетесь?",
      step_2_eyebrow: "Восстановление",
      step_2_title: "Количество во флаконе",
      step_3_eyebrow: "Разведение",
      step_3_title: "Добавленная бактериостатическая вода",
      step_4_eyebrow: "Инъекция",
      step_4_title: "Целевая доза",
      other: "Другое",
      units: "единиц",
      mode_legend: "Направление расчёта",
      mode_forward: "Доза → единицы",
      mode_reverse: "Единицы → доза",
      step_4_reverse_eyebrow: "Инъекция",
      step_4_reverse_title: "Набрано единиц",
      result: {
        eyebrow: "Ваш результат",
        draw_to: "Наберите до",
        dose_is: "Это соответствует",
        concentration: "Концентрация",
        doses_per_vial: "Доз на флакон",
        invalid: "Введите количество во флаконе, объём воды и дозу, чтобы увидеть результат.",
      },
      warnings: {
        exceeds_syringe: "Эта доза больше выбранного шприца. Выберите шприц большего объёма или добавьте меньше воды.",
        too_small: "Меньше 2 делений сложно точно измерить. Добавьте меньше воды, чтобы увеличить объём.",
        water_excess: "Это необычно большое количество воды для одного флакона. Перепроверьте значение.",
        not_whole_graduation: "Значение попадает между делениями. Ориентируйтесь на ближайшую отметку на шприце.",
      },
      vial: {
        cap: "Алюминиевый колпачок",
        stopper: "Пробка из бутилкаучука",
        glass: "Флакон из боросиликатного стекла",
        cake: "Лиофилизированный пептид",
      },
    },
