export default {
  ...
  tools: {
    ...
    "heart-rate-zones": {
      ...
      page_description: "Calculate your personalized heart rate training zones using scientifically proven formulas. Optimize your cardio workouts for fat burning, endurance, and performance.",
      meta: {
        title: "Heart Rate Zones Calculator - Target Heart Rate & Training Zones",
        description: "Calculate your maximum heart rate and personalized training zones. Use basic or Karvonen formulas to find your VO2 Max, Anaerobic, Aerobic, Fat Burn, and Warm Up zones.",
        keywords: "heart rate zones calculator, target heart rate, maximum heart rate, training zones, VO2 max zone, anaerobic zone, aerobic zone, fat burn zone, Karvonen formula, heart rate training",
      },
      ...
      max_heart_rate_info: "Your actual maximum heart rate from a stress test or max effort workout. More accurate than age-based estimates.",
      results: {
      ...
      zones: {
        warm_up: {
          name: "Warm Up Zone",
          intensity: "50-60%",
          benefits: "Prepares body for exercise, improves flexibility",
        ...
        fat_burn: {
          name: "Fat Burn Zone",
          intensity: "60-70%",
          benefits: "Maximum fat burning, builds endurance base",
        ...
        anaerobic: {
          name: "Anaerobic Zone",
          intensity: "80-90%",
          benefits: "Increases speed and power, builds muscle",
        ...
        vo2_max: {
          name: "VO2 Max Zone",
          intensity: "90-100%",
          benefits: "Maximum performance, increases VO2 max",
      ...
      educational: {
        ...
        what_are_zones: {
          ...
          content: "Heart rate zones are ranges of heart beats per minute that correspond to different exercise intensities. Training in specific zones helps you achieve different fitness goals more effectively.",
        },
        why_use_zones: {
          title: "Why Use Heart Rate Zones?",
          content: "Training with heart rate zones ensures you're exercising at the right intensity for your goals. It prevents overtraining, maximizes results, and helps you train more efficiently.",
        },
        zone_distribution: {
          title: "Recommended Weekly Zone Distribution",
          content: "For balanced fitness: 80% in Zones 1-3 (aerobic base), 15% in Zone 4 (threshold), 5% in Zone 5 (VO2 max). Adjust based on your specific goals and fitness level.",
        },
        monitoring: {
          title: "How to Monitor Your Heart Rate",
          content: "Use a chest strap for most accuracy, or a wrist-based monitor for convenience. Check your heart rate regularly during exercise and adjust intensity to stay in your target zone.",
        },
      },
    },
    "one-rep-max": {
