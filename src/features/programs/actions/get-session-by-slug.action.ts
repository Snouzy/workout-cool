    ...
    return {
      session: {
        ...
        exercises: session.exercises.map((ex) => ({
          ...
          instructionsKo: ex.instructionsKo,
          exercise: {
            id: ex.exercise.id,
            ...
            descriptionKo: ex.exercise.descriptionEn || "",
      ...
      program: {
        ...
        titleKo: session.week.program.titleKo,
        ...
        descriptionKo: session.week.program.descriptionKo,
        ...
        slugKo: session.week.program.slugKo,
      },
      week: {
        id: session.week.id,
        ...
        descriptionKo: session.week.descriptionKo,
