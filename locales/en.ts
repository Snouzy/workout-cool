  ...
  tools: {
    ...
    "calorie-calculator": {
      ...
      meta: {
        ...
        description: "Calculate your Total Daily Energy Expenditure (TDEE) and daily caloric needs. Get personalized recommendations for weight loss, maintenance, or muscle gain.",
        keywords: "calorie calculator, TDEE calculator, daily calories, weight loss calculator, caloric needs, BMR calculator, metabolism calculator",
      },
      ...
      activity: {
        sedentary: "Sedentary",
        sedentary_desc: "Little to no exercise",
        light: "Lightly Active",
        light_desc: "Light exercise 1-3 days/week",
        moderate: "Moderately Active",
        moderate_desc: "Moderate exercise 3-5 days/week",
        active: "Very Active",
        active_desc: "Heavy exercise 6-7 days/week",
        very_active: "Extremely Active",
        very_active_desc: "Very heavy physical job or training",
      },
      goal: "Goal",
      goals: {
        lose_fast: "Lose Weight Fast",
        lose_fast_desc: "Lose 2 lbs (1 kg) per week",
        lose_slow: "Lose Weight",
        lose_slow_desc: "Lose 1 lb (0.5 kg) per week",
        maintain: "Maintain Weight",
        maintain_desc: "Stay at current weight",
        gain_slow: "Gain Weight",
        gain_slow_desc: "Gain 1 lb (0.5 kg) per week",
        gain_fast: "Gain Weight Fast",
        gain_fast_desc: "Gain 2 lbs (1 kg) per week",
      },
      results: {
        title: "Your Results",
        bmr: "BMR",
        ...
        carbs: "Carbohydrates",
        fat: "Fat",
        disclaimer: "These calculations are estimates based on average formulas. Actual caloric needs may vary based on individual factors. Consult with a healthcare professional or registered dietitian for personalized advice.",
      },
    },
    "macro-calculator": {
