    ...
    return {
      session: {
        ...
        exercises: session.exercises.map((ex) => ({
          ...
          instructionsUa: ex.instructionsUa,
          ...
          exercise: {
            ...
            descriptionUa: ex.exercise.descriptionEn || "",
      ...
      program: {
        ...
        titleUa: session.week.program.titleUa,
        ...
        descriptionUa: session.week.program.descriptionUa,
        ...
        slugUa: session.week.program.slugUa,
      ...
      week: {
        ...
        descriptionUa: session.week.descriptionUa,
