export default {
  ...
  tools: {
    ...
    "peptide-calculator": {
      ...
      step_2_title: "Quantité dans le flacon",
      step_3_eyebrow: "Dilution",
      step_3_title: "Eau bactériostatique ajoutée",
      step_4_eyebrow: "Injection",
      step_4_title: "Dose cible",
      other: "Autre",
      units: "unités",
      ...
      step_4_reverse_title: "Unités prélevées",
      result: {
        eyebrow: "Votre résultat",
        draw_to: "Prélevez jusqu'à",
        dose_is: "Cela correspond à",
        concentration: "Concentration",
        doses_per_vial: "Doses par flacon",
