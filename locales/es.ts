export default {
  ...
  tools: {
    ...
    "peptide-calculator": {
      ...
      step_2_title: "Cantidad en el vial",
      step_3_eyebrow: "Dilución",
      step_3_title: "Agua bacteriostática añadida",
      step_4_eyebrow: "Inyección",
      step_4_title: "Dosis objetivo",
      other: "Otro",
      units: "unidades",
      mode_legend: "Dirección del cálculo",
      mode_forward: "Dosis → unidades",
      mode_reverse: "Unidades → dosis",
      step_4_reverse_eyebrow: "Inyección",
      step_4_reverse_title: "Unidades cargadas",
      result: {
        eyebrow: "Tu resultado",
        draw_to: "Carga hasta",
        dose_is: "Eso equivale a",
        concentration: "Concentración",
        doses_per_vial: "Dosis por vial",
