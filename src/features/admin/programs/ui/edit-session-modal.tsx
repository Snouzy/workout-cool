      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
          ...
          {activeTab === "zh-TW" && (
            <div className="space-y-4">
              <div>
                <Label htmlFor="edit-titleZhTw">標題（繁體中文）</Label>
                <Input id="edit-titleZhTw" {...register("titleZhTw")} />
                {errors.titleZhTw && <p className="text-sm text-red-500 mt-1">{errors.titleZhTw.message}</p>}
              </div>
              <div>
                <Label htmlFor="edit-descriptionZhTw">說明（繁體中文）</Label>
                <Textarea id="edit-descriptionZhTw" {...register("descriptionZhTw")} rows={3} />
