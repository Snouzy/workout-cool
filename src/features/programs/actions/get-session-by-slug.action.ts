    ...
    return {
      session: {
        ...
        exercises: session.exercises.map((ex) => ({
          ...
          instructionsZhTw: ex.instructionsZhTw,
          exercise: {
            id: ex.exercise.id,
            ...
            descriptionZhTw: ex.exercise.descriptionEn || "",
      ...
      program: {
        ...
        titleZhTw: session.week.program.titleZhTw,
        ...
        descriptionZhTw: session.week.program.descriptionZhTw,
        ...
        slugZhTw: session.week.program.slugZhTw,
      },
      week: {
        id: session.week.id,
        ...
        titleZhTw: session.week.titleZhTw,
        ...
        descriptionZhTw: session.week.descriptionZhTw,
