export default {
  ...
  tools: {
    ...
    "heart-rate-zones": {
      ...
      method_info: "Elige la fórmula que mejor se adapte a tu nivel de fitness y datos disponibles",
      methods: {
        ...
        karvonen_custom_desc: "Más preciso usando frecuencias cardíacas máxima y en reposo medidas",
      },
      age: "Edad",
      age_placeholder: "Ingresa tu edad",
      ...
      zones: {
        ...
        vo2_max: {
          ...
          intensity: "90-100%",
          benefits: "Rendimiento máximo, aumenta el VO2 máx",
          duration: "30 segundos - 2 minutos",
          description: "Intensidad máxima, solo sostenible por ráfagas muy cortas",
        },
      },
      formulas: {
      ...
      tips: {
        ...
        tip1: "Comienza con zonas de menor intensidad si eres nuevo en el ejercicio",
      ...
      faq: {
        ...
        a1: "Si estás comenzando, usa el método Básico. Si conoces tu frecuencia cardíaca en reposo, usa Karvonen por Edad para mayor precisión. Para las zonas más precisas, usa Karvonen con FCM y FCR medidas.",
        q2: "¿Cómo mido mi frecuencia cardíaca en reposo?",
        a2: "Mide tu pulso durante 60 segundos inmediatamente después de despertar, antes de levantarte de la cama. Hazlo durante 3-5 días y usa el promedio. La FCR normal es 60-100 lpm, con valores más bajos indicando mejor condición física.",
        q3: "¿En qué zona debo entrenar para perder peso?",
        a3: "La Zona de Quema de Grasa (60-70%) es óptima para quemar grasa como combustible. Sin embargo, las zonas de mayor intensidad queman más calorías totales. Mezcla zonas para mejores resultados - incluye tanto entrenamientos de quema de grasa como de mayor intensidad.",
        ...
        q5: "¿Puedo entrenar en la zona de VO2 Máx todos los días?",
        a5: "No, la zona de VO2 Máx es extremadamente intensa y solo debe usarse 1-2 veces por semana para intervalos cortos. La mayoría del entrenamiento debe estar en las zonas Aeróbica y Quema de Grasa para construir resistencia y permitir la recuperación.",
      },
      educational: {
