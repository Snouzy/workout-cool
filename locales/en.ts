export default {
  ...
  ads: {
    ...
    dialog_title: "Advertise on Workout.cool",
    dialog_description: "Reach thousands of fitness enthusiasts every month",
    monthly_page_views: "Page Views",
    avg_session_duration: "Avg. Session",
    demographics: "Demographics",
    top_countries: "Top Countries",
    similarweb_placeholder: "SimilarWeb analytics screenshot coming soon",
    pricing_starting_at: "Starting at",
    month: "month",
    feature_logo_link: "Your logo & link displayed on every page",
    feature_visitors: "Visible to 50K+ monthly visitors",
