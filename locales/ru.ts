export default {
  ...
  tools: {
    ...
    "bmi-calculator-hub": {
      ...
      bmi_explanation: "ИМТ - это инструмент скрининга, который помогает оценить, имеете ли вы здоровый вес для своего роста. Выберите подходящий калькулятор для ваших потребностей:",
      ...
      adjusted: {
        ...
        description: "Улучшенный расчет ИМТ, который учитывает мышечную массу и состав тела для более точных результатов у спортивных людей.",
      },
      pediatric: {
        title: "Детский Калькулятор ИМТ",
        description: "Специализированный калькулятор ИМТ для детей и подростков, использующий возрастные и половые процентили и графики роста.",
      },
      comparison: {
