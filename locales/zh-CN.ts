export default {
  ...
  ads: {
    ...
    dialog_title: "在 Workout.cool 投放广告",
    dialog_description: "每月触达数千名健身爱好者",
    monthly_visitors: "月访客",
    monthly_page_views: "页面浏览量",
    avg_session_duration: "平均会话",
    demographics: "用户画像",
    top_countries: "主要国家",
    similarweb_placeholder: "SimilarWeb 分析截图即将推出",
    pricing_starting_at: "起步价",
    month: "月",
    feature_logo_link: "您的Logo和链接展示在每个页面",
    feature_visitors: "每月50K+访客可见",
