export default {
  ...
  ads: {
    ...
    click_to_advertise: "Haz clic para colocar tu anuncio aquí →",
    dialog_title: "Anúnciate en Workout.cool",
    dialog_description: "Llega a miles de entusiastas del fitness cada mes",
    monthly_visitors: "Visitantes / mes",
    monthly_page_views: "Páginas vistas",
    avg_session_duration: "Sesión prom.",
    demographics: "Demografía",
    top_countries: "Principales países",
    similarweb_placeholder: "Captura de análisis SimilarWeb próximamente",
    pricing_starting_at: "Desde",
    month: "mes",
    feature_logo_link: "Tu logo y enlace en cada página",
    feature_visitors: "Visible para 50K+ visitantes mensuales",
