export default {
  ...
  ads: {
    ...
    dialog_title: "Faites votre pub sur Workout.cool",
    dialog_description: "Touchez des milliers de passionnés de fitness chaque mois",
    monthly_visitors: "Visiteurs / mois",
    monthly_page_views: "Pages vues",
    avg_session_duration: "Session moy.",
    demographics: "Démographie",
    top_countries: "Top pays",
    similarweb_placeholder: "Capture d'écran SimilarWeb à venir",
    pricing_starting_at: "À partir de",
    month: "mois",
    feature_logo_link: "Votre logo et lien affichés sur chaque page",
    feature_visitors: "Visible par 50K+ visiteurs mensuels",
