export default {
  ...
  tools: {
    ...
    "heart-rate-zones": {
      title: "心率区间计算器",
      description: "计算您的最佳心率训练区间，以实现最大性能和燃脂效果",
      page_title: "心率区间计算器",
      page_description: "使用科学验证的公式计算您的个性化心率训练区间。优化您的有氧运动，提高燃脂、耐力和表现。",
      meta: {
        title: "心率区间计算器 - 目标心率与训练区间",
        description: "计算您的最大心率和个性化训练区间。使用基础或卡沃宁公式找到您的VO2最大值、无氧、有氧、燃脂和热身区间。",
        keywords: "心率区间计算器, 目标心率, 最大心率, 训练区间, VO2最大值区间, 无氧区间, 有氧区间, 燃脂区间, 卡沃宁公式, 心率训练",
      },
      calculate: "计算区间",
      calculating: "计算中...",
      method: "计算方法",
      method_info: "选择最适合您健身水平和可用数据的公式",
      methods: {
        basic: "基础年龄法",
        basic_desc: "仅使用年龄的简单公式 - 适合初学者",
        karvonen_age: "卡沃宁年龄与静息心率法",
        karvonen_age_desc: "使用年龄和静息心率更准确",
        karvonen_custom: "卡沃宁最大心率与静息心率法",
        karvonen_custom_desc: "使用测量的最大和静息心率最准确",
      },
      age: "年龄",
      age_placeholder: "输入您的年龄",
      resting_heart_rate: "静息心率 (RHR)",
      resting_heart_rate_placeholder: "输入您的静息心率",
      resting_heart_rate_info: "在醒来后、起床前测量您的心率。正常范围是60-100 bpm。",
      max_heart_rate: "最大心率 (MHR)",
      max_heart_rate_placeholder: "输入您的最大心率",
      max_heart_rate_info: "您从压力测试或最大努力锻炼中得到的实际最大心率。比基于年龄的估算更准确。",
      results: {
        title: "您的心率区间",
        max_heart_rate: "最大心率",
      ...
      zones: {
        warm_up: {
          name: "热身区间",
          intensity: "50-60%",
          benefits: "为运动准备身体，提高灵活性",
          duration: "5-10分钟",
          description: "非常轻的强度，用于热身和冷却",
        },
        fat_burn: {
          name: "燃脂区间",
          intensity: "60-70%",
          benefits: "最大燃脂，建立耐力基础",
          duration: "20-40分钟",
          description: "轻度强度，舒适的节奏适合较长时间的锻炼",
        },
        aerobic: {
          name: "有氧区间",
          intensity: "70-80%",
        ...
        anaerobic: {
          ...
          benefits: "提高速度和力量，增肌",
          duration: "2-10分钟",
          description: "高强度，具有挑战性但可持续短时间",
        },
        vo2_max: {
          name: "VO2最大值区间",
          intensity: "90-100%",
          benefits: "最大性能，提高VO2最大值",
          duration: "30秒 - 2分钟",
          description: "最大强度，仅可持续非常短的时间",
        },
      },
      formulas: {
        basic_formula: "基础公式",
        basic_explanation: "THR = MHR × %强度",
        karvonen_formula: "卡沃宁公式",
        karvonen_explanation: "THR = [(MHR - RHR) × %强度] + RHR",
      ...
      tips: {
        title: "训练技巧",
        tip1: "如果您是运动新手，从低强度区间开始",
        tip2: "在每周训练中混合不同区间以获得最佳效果",
        tip3: "使用心率监测器在锻炼期间准确跟踪",
        tip4: "随着您的健身水平提高，您的区间可能会改变 - 定期重新计算",
      },
      faq: {
        title: "常见问题",
        q1: "我应该使用哪种计算方法？",
        a1: "如果您刚开始，使用基础方法。如果您知道静息心率，使用卡沃宁年龄法以获得更高准确性。要获得最精确的区间，使用卡沃宁法配合测量的最大心率和静息心率。",
        q2: "如何测量我的静息心率？",
        a2: "在醒来后立即测量脉搏60秒，起床前进行。连续3-5天进行测量并使用平均值。正常静息心率为60-100 bpm，较低的值表示更好的健身水平。",
        q3: "我应该在哪个区间训练以减肥？",
        a3: "燃脂区间（60-70%）最适合将脂肪作为燃料燃烧。然而，更高强度的区间燃烧更多总卡路里。混合区间以获得最佳效果 - 包括燃脂和高强度锻炼。",
        q4: "220-年龄公式有多准确？",
        a4: "这是一个适用于大多数人的一般估算，但可能相差±10-15 bpm。为了更准确，考虑进行监督下的最大心率测试或使用卡沃宁公式配合您的实际测量值。",
        q5: "我可以每天在VO2最大值区间训练吗？",
        a5: "不可以，VO2最大值区间极其激烈，每周只应使用1-2次进行短间隔训练。大部分训练应该在有氧和燃脂区间，以建立耐力并允许恢复。",
      },
      educational: {
        title: "理解心率训练",
        what_are_zones: {
          title: "什么是心率区间？",
          content: "心率区间是对应不同运动强度的每分钟心跳范围。在特定区间训练可以帮助您更有效地实现不同的健身目标。",
        },
        why_use_zones: {
          title: "为什么使用心率区间？",
          content: "使用心率区间训练确保您以适合目标的正确强度运动。它可以防止过度训练，最大化效果，并帮助您更有效地训练。",
        },
        zone_distribution: {
          title: "推荐的每周区间分配",
          content: "为了平衡健身：80%在1-3区（有氧基础），15%在4区（阈值），5%在5区（VO2最大值）。根据您的具体目标和健身水平进行调整。",
        },
        monitoring: {
          title: "如何监测您的心率",
          content: "使用胸带以获得最高准确性，或使用腕式监测器以方便使用。在运动期间定期检查心率，并调整强度以保持在目标区间内。",
        },
      },
    },
    "one-rep-max": {
